...
- 🔔 **Уведомления** — Telegram, Discord или любой webhook; правила: `accepted_login`, `ban`, `new_country`, `threshold:N/dur`
- 📋 **Браузер событий** — пагинация, фильтры по типу и IP, экспорт в CSV одной кнопкой
...
- ⚙️ **Настройки в браузере** — уведомления, авто-бан и хранение данных настраиваются без перезапуска контейнера
- 📈 **Метрики Prometheus** — эндпоинт `/metrics`: счётчики разобранных строк и активных банов
